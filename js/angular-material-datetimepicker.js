(function (moment) {
  ...
  var template = '<md-dialog class="dtp" layout="column" style="width: 300px;">'
    ...
    + '                <div class="dtp-actual-day" ng-show="picker.currentView == picker.VIEWS.DATE">{{picker.currentDate.format("dddd")}}</div>'
    + '                <div class="dtp-actual-day" ng-show="picker.currentView !== picker.VIEWS.DATE">{{picker.currentDate.format("dddd, MMM Do YYYY")}}</div>'
    + '                <div class="dtp-close text-right">'
    + '                    <a href="#" mdc-dtp-noclick ng-click="picker.hide()">&times;</a>'
    + '                </div>'
    + '            </header>'
    + '            <div class="dtp-date" ng-show="picker.currentView == picker.VIEWS.DATE">'
    + '                <div layout="column">'
    ...
    + '           <span ng-class="{bold: picker.currentView == picker.VIEWS.HOUR, light: picker.currentView == picker.VIEWS.MINUTE}">{{picker.currentNearest5Minute().format(picker.params.shortTime ? "hh" : "HH")}}</span>'
    + '           <span>:</span>'
    + '           <span ng-class="{bold: picker.currentView == picker.VIEWS.MINUTE, light: picker.currentView == picker.VIEWS.HOUR}">{{picker.currentNearest5Minute().format("mm")}}</span>'
    + '          </div>'
    + '            </div>'//start time
